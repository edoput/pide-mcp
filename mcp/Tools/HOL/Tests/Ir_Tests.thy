...
spec_test \<open>Ir table basics and read-only listing\<close>
  discharges \<open>repl_list#T1\<close> and \<open>repl_list#T3\<close> and \<open>repl_list#T4\<close>
...
spec_test \<open>Ir back edge and recovery behavior\<close>
  discharges \<open>repl_back#T1\<close> and \<open>repl_back#T2\<close>
