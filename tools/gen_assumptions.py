...
Isabelle theories export references, not a generated copy of this registry.
tools/spec_gate.py resolves those references against plans/ASSUMPTIONS, just
as it does for the munit metadata manifest.
...
def render_registry(rows):
    ...
    body = [
        ...
        "Gate inputs: mcp_test/lib/munit-spec.json and mcp_test/lib/isabelle-spec.json",
        "",
